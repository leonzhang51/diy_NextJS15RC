export default function Banner() {
  return (
    <div className='relative h-[300px] bg-gradient-to-tr from-orange-300 to-orange-100 overflow-hidden px-6 font-[sans-serif]'>
      <div className='absolute -top-6 -left-6 w-20 h-20 rounded-full bg-blue-500'></div>
      <div className='absolute -top-6 -right-6 w-20 h-20 rounded-full bg-teal-500'></div>

      <div className='grid items-center h-full'>
        <div className='text-center'>
          <h1 className='text-3xl font-bold text-gray-800'>Do It Yourself.</h1>

          <div className='mt-8'>
            <p className='text-sm text-[#333]'>Follow us for the latest updates and exclusive offers!</p>
