...
const NavBar: React.FC<NavBarProps> = () => {
  ...
  const [openProductDropdownMenu, setOpenProductDropdownMenu] = useState<boolean>(false)
  const toggleMobileMenu: void = () => setOpenMobileMenu(!openMobileMenu)
  const toggleProductDropdownMenu: void = () => setOpenProductDropdownMenu(!openProductDropdownMenu)
  return (
      ...
      >
        ...
        <div className='hidden lg:flex lg:gap-x-12'>
          <div className='relative'>
            <button
              type='button'
              className='flex items-center gap-x-1 text-sm font-semibold leading-6 text-zinc-50'
              aria-expanded='false'
              onClick={toggleProductDropdownMenu}
            >
              Product
              <svg
                className='h-5 w-5 flex-none text-zinc-50'
                viewBox='0 0 20 20'
                fill='currentColor'
                aria-hidden='true'
              >
